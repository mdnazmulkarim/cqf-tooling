...
public class CqfMeasure extends Measure {
    ...
    /**
     * @return (The supplemenetal data elements referenced in the library.)
     */
    ...
    public CqfMeasure.TerminologyRef addTerminology() { //3
        CqfMeasure.TerminologyRef t = new CqfMeasure.VersionedTerminologyRef(TerminologyRef.TerminologyRefType.VALUESET, null, null);
        if (this.terminology == null)
            this.terminology = new ArrayList<CqfMeasure.TerminologyRef>();
